...
//
// The application runds readPumpo in a per-connection goroutine. The application
...
// serveWs handles websocket reqeusts from the peer
func serveWs(hub *Hub, w http.ResponseWriter, r *http.Request) {
	...
	// Allow collection of memory referenced by the called by doing all work in
	// new goroutines.
	go client.writePump()
	go client.readPump()
}
